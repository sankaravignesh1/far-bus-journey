...
const CheckRefund = () => {
  ...
  return <Layout>
      <div className="container-custom py-12">
        ...
        {!refundData ? <div className="max-w-md mx-auto card">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${refundData.status === 'Processed' ? 'bg-green-100 text-green-800' : refundData.status === 'Pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800'}`}>
                {refundData.status}
              </div>
            </div>
